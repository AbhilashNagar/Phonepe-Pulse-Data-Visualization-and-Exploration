...
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Abhilash G",
                   page_icon= icon,
                   layout= "wide",
...
mydb = sql.connect(host="108.181.157.254",
                   port="10005",
                   user="admin",
                   password="qWRV1DNA",
...
# Top Charts - USERS          
    if Type == "Users":
        ...
        with col1:
            ...
            if Year == 2024 and Quarter in [1,2,3,4]:
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/AbhilashNagar/Phonepe-Pulse-Data-Visualization-and-Exploration")
